...
<li> Mobile numbers for disbursements should not include the country dialing codes (Test number-Benin: 96062448)</li>
</ul>
<a name="section-2"></a>
...
<p>The <code>user_id</code> is the ID generated when you register and add a business and is available on the <a href="https://dashboard.pals.africa/dashboards/api" target="_blank">Dashboard</a></p>
 ...
 <p><code>purpose</code> is the purpose of the transaction</p>
</blockquote>
