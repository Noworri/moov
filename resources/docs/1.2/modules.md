...
You can use this API call to retreive data related to the system , and extract <code>module_id</code> based on the selected currency, country and newtwork operator.
<a name="section-2"></a>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: left"><code>https://api.pals.africa/api/getmodulesdata</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="text-align: left">GET</td>
            <td style="text-align: left"><code>https://api-test.pals.africa/api/getmodulesdata</code></td>
            <td style="text-align: left">Authorization: Bearer api_keys</td>
        </tr>
    </tbody>
</table>
...
<span class="token property">"data"</span>    <span class="token operator">:</span><span class="token punctuation">[{</span>
    ...
    <span class="token property">"currency"</span>    <span class="token operator">:</span> <span class="token string">"XOF"</span><span class="token punctuation">,</span>
    <span class="token property">"operator"</span>  <span class="token operator">:</span> <span class="token string">"mtn"</span><span class="token punctuation">,</span>
