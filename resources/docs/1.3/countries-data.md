...
You can use this API call to retreive data related to the available countries, along with currency and available newtwork operators for each country.
<a name="section-2"></a>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: left"><code>https://api.pals.africa/api/getcountriesdata</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="text-align: left">GET</td>
            <td style="text-align: left"><code>https://api-test.pals.africa/api/getcountriesdata</code></td>
            <td style="text-align: left">Authorization: Bearer api_keys</td>
        </tr>
    </tbody>
</table>
...
<span class="token property">"data"</span>    <span class="token operator">:</span><span class="token punctuation">[{</span>
    ...
    <span class="token property">"country"</span> <span class="token operator">:</span> <span class="token string">"string"</span>
<span class="token punctuation">}]</span>
