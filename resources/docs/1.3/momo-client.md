...
You can use this API call to retreive data related to the client assotiated to the phone number, network provider and country, you want to disburse money in.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: left"><code>https://api.pals.africa/api/getmomoclientdata</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="text-align: left">GET</td>
            <td style="text-align: left"><code>https://api-test.pals.africa/api/getmomoclientdata</code></td>
            <td style="text-align: left">Authorization: Bearer api_keys</td>
        </tr>
    </tbody>
</table>
...
<div class="code-toolbar">
    ...
    <span class="token property">"phone_no"</span> <span class="token operator">:</span> <span class="token string">"required|string"</span><span class="token punctuation">
...
<span class="token property">"data"</span>    <span class="token operator">:</span><span class="token punctuation">[{</span>
    ...
    <span class="token property">"phone_no"</span>  <span class="token operator">:</span> <span class="token string">string</span><span class="token punctuation">
    <!-- ,</span>
    <span class="token property">"country"</span> <span class="token operator">:</span> <span class="token string">"BJ"</span> -->
<span class="token punctuation">}]</span>
...
<span class="token property">"message"</span> <span class="token operator">:</span> <span class="token string">" Invalid api keys"</span><span class="token punctuation">
<span class="token punctuation">}</span></code><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre><div class="toolbar"><div class="toolbar-item"><a>Copy</a></div></div></div>
...
<span class="token punctuation">{</span>
<span class="token property">"status"</span> <span class="token operator">:</span> <span class="token string">false</span><span class="token punctuation">,
<span class="token property">"message"</span> <span class="token operator">:</span> <span class="token string">"Failed to retreive client name assotiated to this phone number"</span><span class="token punctuation">
<span class="token punctuation">}</span></code><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre><div class="toolbar"><div class="toolbar-item"><a>Copy</a></div></div></div>
