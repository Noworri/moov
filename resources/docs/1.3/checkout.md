...
You can use this API call to collect money from your customers
mobile phones. 
...
<li> Mobile numbers for collections do not required the country dialing codes (example: Benin: 96060822)</li>
</ul>
<a name="section-2"></a>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: left"><code>https://api.pals.africa/api/generatecheckoutlink</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="text-align: left">POST</td>
            <td style="text-align: left"><code>https://api-test.pals.africa/api/generatecheckoutlink</code></td>
            <td style="text-align: left">Authorization: Bearer api_keys</td>
        </tr>
    </tbody>
</table>
...
<div class="code-toolbar">
    ...
    <span class="token property">"callback_url"</span> <span class="token operator">:</span> <span class="token string">"string"</span><span class="token punctuation">,</span>
    <span class="token property">"cancel_url"</span> <span class="token operator">:</span> <span class="token string">"string"</span><span class="token punctuation">,</span>
    ...
    <span class="token property">"amount"</span> <span class="token operator">:</span> <span class="token string">"required|double"</span><span class="token punctuation">,</span>
...
<span class="token property">   "checkout_url"</span> <span class="token operator">:</span> <span class="token string">"url"</span><span class="token punctuation">,</span>
...
<p>Reason 1<code> No Collection Account Found, please add one</code></p>
