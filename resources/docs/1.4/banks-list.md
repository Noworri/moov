...
You can use this API call to get the list of all available banks by country.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: left"><code>https://api.pals.africa/api/getbankslist/:country</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td style="text-align: left">POST</td>
            <td style="text-align: left"><code>https://api-test.pals.africa/api/getbankslist/:country</code></td>
            <td style="text-align: left">Authorization: Bearer api_keys</td>
        </tr>
    </tbody>
</table>
...
<div class="code-toolbar">
    <pre class="language-php" style="position: relative"><code class="  language-php">country (CI, BJ, SN, TG, ML, GW, BF)</code></pre>
</div>
...
<span class="token property">"message"</span> <span class="token operator">:</span> <span class="token string">"Banks fetched successfully"</span><span class="token punctuation">,</span>
...
<p>Reason 1<code> No banks found for country code</code></p>
<p>Reason 2<code> Invalid API Keys</code></p>
