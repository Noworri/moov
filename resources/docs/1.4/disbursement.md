...
<li>A disbursement to a mobile wallet must be less than or equal to XOF 1,700,000 per transaction.</li>
<li>A disbursement to merchant accounts must be less than or equal to XOF 1,500,000 per transaction.</li>
</ul>
<a name="section-2"></a>
...
<div class="code-toolbar">
    ...
    <span class="token property">"purpose"</span> <span class="token operator">:</span> <span class="token string">"string"</span><span class="token punctuation">,</span>
