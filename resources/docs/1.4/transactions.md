...
You can use these API calls to get your processed mobile transactions, as well as check the status of a disbursement
...
<div class="code-toolbar">
   <ul>
       <pre class="language-php" style="position: relative"><code class="  language-php">user_id</code></pre>
       <pre class="language-php" style="position: relative"><code class="  language-php">reference</code></pre>
   </ul>
</div>
...
<span class="token property">"data"</span>    <span class="token operator">:</span><span class="token punctuation">[</span><span class="token punctuation">{</span>
    ...
    <span class="token property">"charges"</span> <span class="token operator">:</span> <span class="token string">"string"</span><span class="token punctuation">,</span>
